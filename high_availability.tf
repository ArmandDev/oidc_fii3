# # ============================================================
# # CloudPulse — High availability stack
# #
...
# #   • IAM role/profile, launch template (encrypted EBS + user_data / app.py.tftpl)
# #   • ASG → internal ALB + target group, listener 403 + header rule, VPC Origin
# #   • WAF (CloudFront) + CloudFront distribution (aliases + ACM in us-east-1)
# #
# # HA additions (on top of the above):
# #   • Provider aws.secondary (eu-west-3); S3 cross-region replication + replica bucket
# #   • DynamoDB global-table style replica { region_name = eu-west-3 }
# #   • ASG min_size / desired_capacity = 2 (max 3): capacity across AZs
# #   • CloudFront CNAMEs from var.cloudfront_aliases_high_availability + ACM high.*
# #   • Extra alarms: DynamoDB ReplicationLatency, S3 TotalReplicationTime
# #
# # Activation: comment out data_encryption.tf (whole file) and uncomment this file.
# # ============================================================
# terraform {
#   required_providers {
#     aws = {
...
#   # Ensure this object is uploaded only after CRR is active,
#   # otherwise first upload may not be replicated to eu-west-3.
...
#   default_root_object = ""
#   aliases             = var.cloudfront_aliases_high_availability
...
#     for_each = length(var.cloudfront_aliases_high_availability) > 0 ? [1] : []
#     content {
#       acm_certificate_arn      = data.aws_acm_certificate.high.arn
...
#   statistic           = "Average"
#   threshold           = "2"
#   alarm_description   = "Alarm when fewer than 2 healthy targets (matches ASG min/desired 2)"
#   alarm_actions       = []
...
#   statistic           = "Average"
#   threshold           = "10000"
#   alarm_description   = "DynamoDB replica replication lag (ms); ReceivingRegion matches aws_dynamodb_table.cloudpulse replica"
#   alarm_actions       = []
#   treat_missing_data  = "notBreaching"

#   dimensions = {
#     TableName       = aws_dynamodb_table.cloudpulse.name
#     ReceivingRegion = "eu-west-3"
#   }
# }
...
#   statistic           = "Maximum"
#   threshold           = "900000"
#   alarm_description   = "S3 cross-region replication time in milliseconds"
#   alarm_actions       = []
#   treat_missing_data  = "notBreaching"
