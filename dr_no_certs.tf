# # ============================================================
# # CloudPulse — DR without custom ACM (Terraform addresses use nc_* prefix).
# #
# # Safe beside dr.tf in one module. Outputs: nc_dr_cloudfront_domain_name, etc.
# # For a second real deployment, use a distinct var.dr_stack_name / bucket prefix.
# # ============================================================
...
#   replica {
#     region_name = data.aws_region.nc_dr_secondary_region.name
...
#   # Must live in the same region as aws_sns_topic.nc_dr_failover — SNS cannot invoke Lambda cross-region.
